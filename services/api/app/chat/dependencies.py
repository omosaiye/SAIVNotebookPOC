...
from services.api.app.chat.retrieval import FileBackedRetrievalService
...
def get_chat_service() -> ChatService:
    return ChatService(
        ...
        retrieval_service=FileBackedRetrievalService(file_repository=get_file_repository()),
